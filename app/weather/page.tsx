...
export default function WeatherPage() {
  ...
  // Load cached weather on component mount
  useEffect(() => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Dashboard del Clima</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Widget de ubicación en caché */}
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-800">Tu Ubicación</h2>
            <button
        ...
        {/* Widget de búsqueda */}
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-800">Buscar Ubicación</h2>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-800">Ubicación Aleatoria</h2>
            <button
      ...
      <div className="mt-16 bg-white rounded-lg shadow-md p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Información sobre la API</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="text-3xl font-bold text-blue-600">OpenMeteo</div>
            <div className="text-gray-600">API del Clima</div>
            <p className="text-sm text-gray-500 mt-2">Datos meteorológicos gratuitos y precisos</p>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-green-600">10 min</div>
            <div className="text-gray-600">Caché</div>
            <p className="text-sm text-gray-500 mt-2">Los datos se almacenan localmente por 10 minutos</p>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-purple-600">20+</div>
            <div className="text-gray-600">Ubicaciones</div>
            <p className="text-sm text-gray-500 mt-2">Ciudades aleatorias disponibles</p>
          </div>
        </div>
      </div>
    </div>
